...
namespace Ophim\ThemeIpc\Controllers;
...
class ThemeIpcController
{
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themeipc.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themeipc.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themeipc.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themeipc.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
    ...
    public function rateMovie(Request $request, $movie)
    {
            ...
            return response()->json(['rating_star' => number_format($movie->rating_star, 1), 'rating_count' => $movie->rating_count]);
    }
    ...
    public function getMovieforHome(Request $request)
    {
        /** @var Catalog */
